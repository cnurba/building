...
//  void initState() {
//   super.initState();
//   animationController = new AnimationController(vsync: this,duration: Duration(milliseconds: 5000))..addListener(() {
//     wavePoints.clear();
...
//            Offset(
//              i.toDouble(),
//              calc *waveHeigth*normalizer+widget.yOffset,
//
//            ));
//
//     }
